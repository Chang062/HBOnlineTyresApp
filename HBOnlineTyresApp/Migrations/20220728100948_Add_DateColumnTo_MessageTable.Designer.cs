...
namespace HBOnlineTyresApp.Migrations
{
    ...
    [Migration("20220728100948_Add_DateColumnTo_MessageTable")]
    partial class Add_DateColumnTo_MessageTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HBOnlineTyresApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HBOnlineTyresApp.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HBOnlineTyresApp.Models.Order", b =>
                {
                    b.HasOne("HBOnlineTyresApp.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HBOnlineTyresApp.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
