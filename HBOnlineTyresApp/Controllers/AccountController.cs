...
namespace HBOnlineTyresApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM registerVM)
        {
            ...
            {
                TempData["Error"] = "Invalid password. Your password must be at least eight characters long with uppercase, lowercase, number and special character (example: 2@Change)";
